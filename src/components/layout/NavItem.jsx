    ...
    return (
        <div>
            <div className='relative playfair' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                <li className='group text-tertiary text-lg font-normal relative pb- mr-8'> <a href={each.link} className='tracking-[0.1rem] flex items-center'>{each.text.toUpperCase()} {each.subNav && <IoMdArrowDropdown />}</a> <div className="absolute bottom-0 w-[0px] transition-all group-hover:w-full pt-[2px] bg-white"></div> </li>
